...
<div class="container">
    <main id="maincontent" class="middle-align">
        <?php
            $theme_lay = get_theme_mod( 'vw_ecommerce_store_theme_options','Right Sidebar');
            if($theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        ...
                        printf( esc_html__( 'Results For: %s','vw-ecommerce-store'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                        ...
                        <div class="navigation">
                            <?php
                                ...
                                the_posts_pagination( array(
                                    'prev_text'          => __( 'Previous page', 'vw-ecommerce-store' ),
                                    'next_text'          => __( 'Next page', 'vw-ecommerce-store' ),
                                    'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-ecommerce-store' ) . ' </span>',
                                ) );
                            ?>
