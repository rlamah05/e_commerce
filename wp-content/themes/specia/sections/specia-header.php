<?php 					
	...
	if ( ($hide_show_social) || ($hide_show_contact_infos) == '1') :
?>
            ...
            <div class="col-md-6 col-sm-7">
				<?php if($hide_show_contact_infos == '1') { ?>
					...
					<ul class="info pull-right">
						<?php if($header_email) { ?> 
							<li class="header-email"><a href="mailto:<?php echo esc_html($header_email); ?>"><i class="fa fa-envelope"></i> <?php echo esc_html($header_email); ?> </a></li>
						<?php } ?>
						
						<?php if($header_contact) { ?> 
							<li class="header-contact"><a href="tel:<?php echo esc_html($header_contact); ?>"><i class="fa fa-phone-square"></i> <?php echo esc_html($header_contact); ?></a></li>
						<?php } ?>
					</ul>
					<!-- /End Contact Info -->
				<?php } ?>
