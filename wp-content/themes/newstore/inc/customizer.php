...
function newstore_customize_register($wp_customize) {
	...
	if(class_exists('NewStore_Upsale_Customize_Section')){
	...
	$wp_customize->add_setting('newstore_theme_primary_color', array(
		'sanitize_callback' => 'sanitize_text_field',
		'transport'         => 'postMessage',
		'default'           => '#E91E63',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'newstore_theme_primary_color', array(
		'label'   => __('Primary Color', 'newstore'),
		'section' => 'colors',
	)));
		...
		public function render() {
		    ...
		    <li id="accordion-section-<?php echo esc_attr($this->id); ?>"class="<?php echo esc_attr($classes); ?>">
		        <div class="themefarmer-upsale">
		          	<a href="<?php echo esc_url('https://themefarmer.com/theme/newstore-pro/'); ?>" target="_blank" class="themefarmer-upsale-bt" id="themefarmer-pro-button"><?php esc_html_e('VIEW PRO VERSION ', 'newstore');?></a>
		        </div>
		    </li>
		    <?php
		}
